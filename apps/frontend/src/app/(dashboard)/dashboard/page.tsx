...
// Icon map for departments (same as departments/page.tsx)
...
const deptIconMap: { [key: string]: React.FC<{ className?: string }> } = {
  Business: BusinessIcon, HomeWork: HomeWorkIcon, MeetingRoom: MeetingRoomIcon,
  Warehouse: WarehouseIcon, LocalShipping: LocalShippingIcon, Engineering: EngineeringIcon,
  Biotech: BiotechIcon, Computer: ComputerIcon, Store: StoreIcon, HelpCenter: HelpCenterIcon,
  Default: BusinessIcon,
};
const renderDeptIcon = (iconName?: string, className?: string) => {
  const Icon = iconName && deptIconMap[iconName] ? deptIconMap[iconName] : deptIconMap.Default;
              ...
              {departments.map((dept) => {
                ...
                return (
                  ...
                  >
                    ...
                    {dept.area && (
                      <p className="text-sm opacity-80 mb-2">{dept.area}</p>
                    )}
                        ...
                        <div className="p-4 text-white">
                          <div className="flex justify-between items-start mb-3">
                            <div>
                              ...
                              {dept.area && (
                                <p className="text-sm opacity-80">{dept.area}</p>
                              )}
                            </div>
                            <div className="p-2 bg-white/20 rounded-lg">
                              {renderDeptIcon(dept.icon, 'w-6 h-6')}
                            </div>
                          </div>
